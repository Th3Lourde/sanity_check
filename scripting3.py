...
def assemble_png(u_in):
    ...
    for i in range(0,16):
        ...
        for j in range(0,int(len(bytes)/LEN)):
...
# r = assemble_png('11111111111ºlla_')

# r = assemble_png('4ab_e_NN`fdc^ºa_')
#
# print(r)
...
def johnAscript():
    ...
    for k in range(15,-1, -1):
        ...
        fuzz = "11111111111ºlla_"

        s = "Possible characters at place {} are: [".format(term)
